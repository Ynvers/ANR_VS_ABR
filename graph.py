...
axs[0, 0].set_ylabel("Temps en ms")
axs[0, 0].set_xlabel("Nombre d'éléments dans l'arbre")
axs[0, 0].legend()
...
axs[0, 1].set_ylabel("Temps en ms")
axs[0, 1].set_xlabel("Nombre d'éléments dans l'arbre")
...
axs[1, 0].set_ylabel("Temps en ms")
axs[1, 0].set_xlabel("Nombre d'éléments dans l'arbre")
...
axs[1, 1].set_ylabel("Temps en ms")
axs[1, 1].set_xlabel("Nombre d'éléments dans l'arbre")
